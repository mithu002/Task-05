...
public class Rugby4 {
	public static void main(String[] args) {
		List<RugbyClub> table = Arrays.asList(
				...
				new RugbyClub(10, "London Irish", 22, 73, -1, 14, 442, 578, -136, 46, 57, 4, 6, 40),
				new RugbyClub(11, "Woverhampton", 22, 68, 1, 16, 475, 545, -70, 57, 61, 74, 8, 34),
				new RugbyClub(12, "West Ham", 22, 0, 70, 22, 223, 1021, -798, 29, 147, 1, 70, 10));

		System.out.println("Several clubs have 68 points");
		table.stream().filter(club -> club.getPoints() == 68).forEach(System.out::println);

		System.out.println();
		System.out.println("Clubs with 73 points");
		table.stream().filter(club -> club.getPoints() == 73).forEach(System.out::println);
