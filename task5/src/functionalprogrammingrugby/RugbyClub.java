...
public class RugbyClub implements Comparable<RugbyClub> {
	...
	public RugbyClub(int position, String club, int played, int won, int drawn, int lost, int pointsFor, int pointsAgainst,
			int pointsDifference, int triesFor, int triesAgainst, int tryBonus, int losingBonus, int points) {
	...
	public String toString() {
		return String.format("%-3d%-20s%10d%10d%10d", position, club, pointsFor, pointsAgainst, points);
	}
	...
	public int compareTo(RugbyClub c) {
